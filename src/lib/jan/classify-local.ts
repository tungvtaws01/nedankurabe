...
const RULES: Array<[Category, RegExp]> = [
  ...
  ['nasal_aspirator', /鼻吸い器|鼻水吸引|電動鼻吸|手動鼻吸|メルシーポット|ベビースマイル.*鼻|鼻吸引器/],
  ['thermometer',     /体温計(?!カバー|ケース|入れ)|検温(?!カバー)|耳式体温|非接触.*体温/],
  ['safety_gate',     /ベビーゲート|安全ゲート|セーフティゲート|ベビーフェンス|階段ゲート|ドアゲート|オートゲート/],
  ['playmat',         /プレイマット|ジョイントマット|ベビーマット|フロアマット.*ベビー|ベビー.*フロアマット|おくだけマット/],
